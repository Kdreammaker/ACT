...
export default function PersonalActivity() {
  ...
  const filteredActivities = activities.filter(activity => {
    const matchesFilter = activeFilter === 'all' || 
      (activeFilter !== 'all' && (activity.company.toLowerCase().includes(activeFilter.toLowerCase()) || 
      activity.code.includes(activeFilter)));
  ...
  const companies = [...new Set(activities.map(activity => activity.company))];
